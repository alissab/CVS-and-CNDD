...
prior <- c(set_prior("normal(0, 1)", class = "b", coef= "tmax"),
           ...
           set_prior("normal(0, 1)", class = "b", coef= "tmax:plot_tree_BA"),
           set_prior("normal(0, 1)", class = "b", coef= "mean_prec:plot_tree_BA"),
           set_prior("normal(0, 1)", class = "b", coef= "twi:plot_tree_BA"),
           set_prior("normal(0, 1)", class = "b", coef= "pc1:plot_tree_BA"),
           set_prior("normal(0, 1)", class = "b", coef= "pc2:plot_tree_BA"),
           ...
           set_prior("normal(5, 5)", class = "sd", coef = "plot_tree_BA", group = "species"),
           set_prior("normal(1, 5)", class = "sd", coef = "plot_tree_BA:tmax", group = "species"),
           set_prior("normal(1, 5)", class = "sd", coef = "plot_tree_BA:mean_prec", group = "species"),
           set_prior("normal(1, 5)", class = "sd", coef = "plot_tree_BA:twi", group = "species"),
...
mod <- brm( sap_plot_count ~
              ...
              (1 + plot_tree_BA +                     # group-level main and interactive effects
                 plot_tree_BA:tmax +
                 plot_tree_BA:mean_prec +
                 plot_tree_BA:twi + 
                 plot_tree_BA:pc1 + 
                 plot_tree_BA:pc2 | species) +
              
              plot_tree_BA:tmax +                     # pop'n-level interactions
              plot_tree_BA:mean_prec +
              plot_tree_BA:twi + 
              plot_tree_BA:pc1 + 
              plot_tree_BA:pc2,
...
save.image("chap3_hardw_full_tot.RData")
