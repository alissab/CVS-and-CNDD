...
prior <- c(set_prior("normal(0, 1)", class = "b", coef= "Elevation"),
           ...
           set_prior("normal(0, 1)", class = "b", coef= "pc1:propCon"),
           set_prior("normal(0, 1)", class = "b", coef= "pc2:plot_tree_BA"),
           set_prior("normal(0, 1)", class = "b", coef= "pc2:propCon"),
           set_prior("normal(0, 1)", class = "b", coef= "top1:plot_tree_BA"),
           set_prior("normal(0, 1)", class = "b", coef= "top1:propCon"),
           set_prior("normal(0, 1)", class = "b", coef= "top2:plot_tree_BA"),
           set_prior("normal(0, 1)", class = "b", coef= "top2:propCon"),
           set_prior("normal(0, 1)", class = "b", coef= "top3:plot_tree_BA"),
           set_prior("normal(0, 1)", class = "b", coef= "top3:propCon"),
...
mod2 <- brm( sap_plot_count ~
                       ...
                       plot_tree_BA:top3 + propCon:top3,
...
save.image("plots_mod2.RData")

# model selection
k_mod <- kfold(mod2, K = 10)
save.image("plots_mod2.RData")
